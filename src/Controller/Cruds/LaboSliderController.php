...
use Aequation\LaboBundle\Form\Type\SliderType;
...
class LaboSliderController extends LaboEntityController
{

    public const CLASSNAME = Slider::class;
    public const ENTITY = 'Slider';
    public const ENTITYL = 'slider';
    public const ENTITY_TYPE = SliderType::class;
