...
class AppContext implements AppContextInterface
{
    ...
    protected ?FirewallConfig       $_firewall                      = null;
    ...
    protected function initialize(): bool
    {
        ...
        $this->_firewall                    = $this->request ? $this->security->getFirewallConfig($this->request) : null;
        ...
        $this->_public                      = $this->_firewall instanceof FirewallConfig ? in_array(strtolower($this->getFirewallName()), $this->appService::PUBLIC_FIREWALLS) : false;
        ...
        // if($valid && !$this->isTempContext()) {
        //     $this->session->set($this->appService::CONTEXT_SESSNAME, $this->jsonSerialize());
        // }
        return $valid;
    }
    ...
    {
        return $this->_firewall instanceof FirewallConfig ? $this->_firewall->getName() : null;
